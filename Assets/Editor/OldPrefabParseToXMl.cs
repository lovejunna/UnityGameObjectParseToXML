...
public class OldPrefabParseToXM : Editor
{
    //将所有游戏场景导出为XML格式
    [MenuItem("Assets/OldPrefabParseToXMl", false, 1)]
    [MenuItem("GameObject/OldPrefabParseToXMl", false, 1)]
    [MenuItem("Window/OldPrefabParseToXMl")]
            ...
            if (component != null)
            {
                ...
                switch ($"{componentName}")
                {
                    case nameof(RectTransform):
                        ...
                        gameObject.SetAttribute("scaleX", (int)rectTransform.localScale.x + "");
                        gameObject.SetAttribute("scaleY", (int)rectTransform.localScale.y + "");
                        gameObject.SetAttribute("rotation", (int)rectTransform.localEulerAngles.z + "");
                        gameObject.SetAttribute("width", (int)rectTransform.rect.width + "");
                        gameObject.SetAttribute("height", (int)rectTransform.rect.height + "");
                        gameObject.SetAttribute("anchorOffsetX", (int)rectTransform.pivot.x + "");
                        gameObject.SetAttribute("anchorOffsetY", (int)rectTransform.pivot.y + "");
                        gameObject.SetAttribute("anchorMin", rectTransform.anchorMin.ToString() + "");
                        gameObject.SetAttribute("anchorMax", rectTransform.anchorMax.ToString() + "");
                        if (rectTransform.anchorMin == new Vector2(0.5f, 0.5f) && rectTransform.anchorMax == new Vector2(0.5f, 0.5f))
                        {
                            gameObject.SetAttribute("horizontalCenter", 0 + "");
                            gameObject.SetAttribute("verticalCenter", 0 + "");
                        }
                        break;
                    case nameof(Canvas):
                    ...
                    case nameof(Button):
                        ...
                        if (button.onClick.GetPersistentEventCount() > 0)
                        {
                            ...
                            {
                                componentProps.SetAttribute($"onClickEventName{index}", button.onClick.GetPersistentMethodName(index));
                            }
                        }
                        break;
